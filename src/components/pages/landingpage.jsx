...
// const LandingPage = () => {
//   return (
//     <main className="xl:ml-96 p-4 lg:-mt-20 flex flex-col gap-10 sm:gap-20 py-10 sm:py-20 ">
//       <section className="text-center -ml-10  ">
//         <h1 className="flex flex-col items-center justify-center gradient-title font-bold text-3xl sm:text-6xl lg:text-8xl tracking-tighter py-4">
//           Unlock your potential,
//           <h2 className="mb- mt-3 lg:mt-6 lg:mb-6">land your dream job</h2>
...
//           </span>
//         </h1>
//         <p className="text-gray-300 sm:mt-4  sm:text-xl lg:text-2xl  tracking-tighter">
//           Explore thousands of job listings or find the perfect candidate
//         </p>
//       </section>
//       <div className="flex  gap-6 lg:gap-10 xl:-mt-10 justify-center">
//         <Link to={"/jobs"}>
//           <Button variant="blue" className=" " size="xl">
//             Find Jobs
//           </Button>
//         </Link>
//         <Link to={"/post-job"}>
...
//         <Card>
//           <CardHeader>
//             <CardTitle className="text-xl sm:font-bold lg:font-bold xl:font-bold">For Job Seekers</CardTitle>
//           </CardHeader>
//           <CardContent className="text-xl sm:font-bold lg:font-bold xl:font-bold">
//             Search and apply for jobs, track applications, and more.
//           </CardContent>
//         </Card>
//         <Card>
//           <CardHeader>
//             <CardTitle className="text-xl sm:font-bold lg:font-bold xl:font-bold">For Employers</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//       <Accordion type="multiple" className="w-full text-sm  lg:text-xl tracking-tighter">
//         {faqs.map((faq, index) => (
//           <AccordionItem key={index} value={`item-${index + 1}`}>
//             <AccordionTrigger >{faq.question}</AccordionTrigger>
//             <AccordionContent className="lg:text-xl">{faq.answer}</AccordionContent>
//           </AccordionItem>
//         ))}
//       </Accordion>
//     </main>
